...
export default function SinglePopularCourse({ data }: props) {
  return (
    <Link
      ...
      className="mobile-carousel w-[80%] text-white lg:hover:translate-y-[-5%] lg:transition-all lg:duration-300"
    >
      <div className=" grid grid-rows-[175px_minmax(200px,200px)_40px] grid-cols-1 w-[100%] mx-[5%] bg-grey-dark rounded-xl shadow-md">
        ...
        <div className="flex flex-col items-start justify-between mt-[5%] mx-[5%]">
          <div className="grid grid-cols-1 grid-rows-[40px_40px_60px] overflow-hidden">
            ...
            <p className="text-grey-medium text-lg ellipsis-2line">
              {data.description}
            </p>
          </div>
          <div className="mb-[5%]">
